...
exec .venv/bin/accelerate launch \
  ...
  --inference.checkpoint_path=/scratch/u6pw/ql337.u6pw/projects/Evo-RL/outputs/value_train/pistart0.6-insert-carrot \
  ...
  --acp.value_field=complementary_info.value_pistar06_run4_n50_r30 \
  --acp.advantage_field=complementary_info.advantage_pistar06_run4_n50_r30 \
  --acp.indicator_field=complementary_info.acp_indicator_pistar06_run4_n50_r30 \
  --output_dir=/scratch/u6pw/ql337.u6pw/projects/Evo-RL/outputs/value_infer/pistar06_run4_n50_r30 \
  --job_name=pistar06_run4_n50_r30.infer
