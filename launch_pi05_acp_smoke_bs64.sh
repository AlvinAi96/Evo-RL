...
exec .venv/bin/accelerate launch \
  ...
  --output_dir=/scratch/u6pw/ql337.u6pw/projects/Evo-RL/outputs/train/pi05_insert_carrot_v2_r1_acp_smoke_bs64 \
  --job_name=pi05_insert_carrot_v2_r1_acp_smoke_bs64 \
  --wandb.enable=false \
